...
HidSim set UPS.PowerConverter.Input[1].Frequency 0
HidSim set UPS.PowerConverter.Input[1].PresentStatus.Boost 0
HidSim set UPS.PowerConverter.Input[1].PresentStatus.Buck 0
HidSim set UPS.PowerConverter.Input[1].PresentStatus.FrequencyOutOfRange 1
HidSim set UPS.PowerConverter.Input[1].PresentStatus.InternalFailure 0
HidSim set UPS.PowerConverter.Input[1].PresentStatus.Used 0
HidSim set UPS.PowerConverter.Input[1].PresentStatus.VoltageOutOfRange 1
HidSim set UPS.PowerConverter.Input[1].Voltage 0
...
HidSim set UPS.PowerSummary.PresentStatus.ACPresent 0
HidSim set UPS.PowerSummary.PresentStatus.BelowRemainingCapacityLimit 0
HidSim set UPS.PowerSummary.PresentStatus.Charging 0
HidSim set UPS.PowerSummary.PresentStatus.CommunicationLost 0
HidSim set UPS.PowerSummary.PresentStatus.Discharging 1
